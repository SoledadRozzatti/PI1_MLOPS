...
def peliculas_mes(mes:str): 
    '''Se ingresa el mes en español y la función retorna la cantidad de películas que se estrenaron ese mes 
...
def peliculas_dia(dia:str): 
    '''Se ingresa el día de la semana y la función retorna la cantidad de películas que se estrenaron 
...
def franquicia(franquicia: str):
    ...
    '''Esta función recibe como argumento la franquicia y retorna cantidad de peliculas, ganancia total y ganancia promedio
...
punt_matrix = df_m.pivot_table(index='title', values='puntaje_promedio')
